...
class NativeSpec {
  ...
  def utxoNames: Unit = {
    val generated =
      for (_ <- 0 to 50) yield Haiku.name(fr.acinq.eclair.randomBytes32)
  ...
  def generatePubFromPriv: Unit = {
    ...
    assertTrue(
      publicKey.toUncompressedBin == ByteVector.fromValidHex(
        "0450863ad64a87ae8a2fe83c1af1a8403cb53f53e48" +
  ...
  def recoverPubKeyFromSig: Unit = {
    ...
    val message = ByteVector.fromValidHex(
  ...
  def recoverPubKeyFromSig2: Unit = {
    val priv: PrivateKey = PrivateKey(
      ByteVector.fromValidHex(
        "a6f0d82981c7d7fd424c97548be1b246161097532e102c0457f46ad587069891"
      )
    )
    val message: ByteVector = ByteVector.fromValidHex(
      "47326140f20c22e45e2fd0c7ec600b4a0134388083b713a19bb3596629c9e447"
    )
    val pub: PublicKey = PublicKey(
      ByteVector.fromValidHex(
        "03eec785a16054b40bfe15c287beca7f214f88742501fabbe18251502c0ea0588f"
      )
    )
    val recid: Int = 1
