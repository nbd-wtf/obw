...
import com.fiatjaf.wallet.Colors.{cardIn, cardOut, cardZero}
  ...
  def updateView(): Unit = {
    ...
    WalletApp.txDataBag.db.txWrap {
      ...
      for (summary <- txSummary) {
        ...
        addFlowChip(
          slotTitle.flow,
          getString(stats_item_transactions).format(summary.count),
          R.drawable.border_gray
        )
        addFlowChip(
          slotTitle.flow,
          getString(stats_item_received) format WalletApp.denom
            .directedWithSign(
        ...
        addFlowChip(
          slotTitle.flow,
          getString(stats_item_sent) format WalletApp.denom.directedWithSign(
            0L.msat,
        ...
        addFlowChip(
          slotTitle.flow,
          getString(stats_item_fees) format WalletApp.denom.directedWithSign(
            0L.msat,
      ...
      for (summary <- paymentSummary) {
        ...
        addFlowChip(
          slotTitle.flow,
          getString(stats_item_payments).format(summary.count),
          R.drawable.border_gray
        )
        addFlowChip(
          slotTitle.flow,
        ...
        addFlowChip(
          slotTitle.flow,
          getString(stats_item_fees_saved) format feesSaved,
          R.drawable.border_gray
        )
        statContainer.addView(slotTitle.view)
      }
      ...
      for (summary <- relaySummary) {
        ...
        addFlowChip(
          slotTitle.flow,
          getString(stats_item_relays).format(summary.count),
          R.drawable.border_gray
        )
        addFlowChip(
          slotTitle.flow,
          getString(stats_item_relayed) format WalletApp.denom
            .parsedWithSign(summary.relayed, cardIn, cardZero),
          R.drawable.border_gray
        )
        addFlowChip(
          slotTitle.flow,
          getString(stats_item_earned) format WalletApp.denom.directedWithSign(
            summary.earned,
            0L.msat,
            cardOut,
            cardIn,
